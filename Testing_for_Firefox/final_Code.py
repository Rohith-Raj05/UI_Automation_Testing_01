...
def take_screenshot(url, browser, width, height, idx):
    ...
    try:
        ...
        folder_name = f"Testing_for_Firefox/URL{idx}_screenshots/{browser.capitalize()}/{folder_type}/{width}x{height}"
...
def main():
    ...
    type_of_browser ="firefox" # to indicate on which type of browser we are working on 
